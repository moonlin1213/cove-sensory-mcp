...
from .inputs import SenseVideoInput


async def sense_video(services: AppServices, input: SenseVideoInput) -> CallToolResult:
    try:
        return success_result(await services.sense("video", input))
